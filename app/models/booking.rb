class Booking < ApplicationRecord
  ...
  def reservations_must_not_overlap
    ...
    errors.add(:start_date, 'This book is not available at the dates you chose. Please update the booking start date and/or end date.')
    errors.add(:end_date, 'This book is not available at the dates you chose. Please update the booking start date and/or end date.')
  end
end
